...
class EmbedCatalogController extends Controller
{
    ...
    {
        return (string) env('XCONECTC_HOST_BOOTSTRAP_API_KEY', (string) env('XAPPS_API_KEY', ''));
    }
    ...
    public function bridgeSign(Request $request)
    {
        ...
        return response()->json(array(
            'message' => 'Signing is not configured in xconectc-host. Provide envelope in request body or wire a signer.',
        ), 501);
    }
