...
const MODE_COPY = {
  "single-panel": {
    ...
    subtitle:
      "Catalog and widget navigation stay in one embedded surface. This is the leanest workspace shape for teams starting with xconect.",
  },
  "split-panel": {
...
const HEADER_COLLAPSE_STORAGE_KEY = "xconect_reference_host_header_collapsed_v1";
const THEME_STORAGE_KEY = "xconect_reference_host_theme_v1";
