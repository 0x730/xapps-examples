...
import { createXconectMarketplaceRuntime } from "./xconect-host-runtime.js";
...
main().catch((error) => {
  console.error("[xconect-host] marketplace bootstrap failed", error);
  document.body.innerHTML = `
    <div style="padding:2rem;font-family:Trebuchet MS,Segoe UI,sans-serif;color:#1f1613;">
      <h1 style="font-family:Georgia,serif;">Xconect host bootstrap failed</h1>
