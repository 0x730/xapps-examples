...
const MODE_COPY = {
  "single-panel": {
    ...
    subtitle:
      "Catalog and widget navigation stay in one embedded surface. This is the leanest workspace shape for teams starting with xconecta.",
  },
  "split-panel": {
...
const HEADER_COLLAPSE_STORAGE_KEY = "xconecta_reference_host_header_collapsed_v1";
const THEME_STORAGE_KEY = "xconecta_reference_host_theme_v1";
...
const shellApi = createHostShellApi({
  ...
  localeStorageKey: "xconecta_reference_host_locale_v1",
