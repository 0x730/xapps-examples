...
import { resolveXconectTheme } from "./xconecta-host-runtime.js";
...
main().catch((error) => {
  console.error("[xconecta-host] single-xapp bootstrap failed", error);
  document.body.innerHTML = `
    <div style="padding:2rem;font-family:Trebuchet MS,Segoe UI,sans-serif;color:#1f1613;">
      <h1 style="font-family:Georgia,serif;">Xconect A single-xapp bootstrap failed</h1>
