...
const BACKEND_KIT_OPTIONS = normalizeBackendKitOptions({
  ...
  branding: {
    tenantName: "Xconect A",
    serviceName: "xconecta-tenant-backend",
    stackLabel: "node-fastify",
  },
  assets: {
    seedLogo: {
      filePath: TENANT_SEED_LOGO_FILE,
      routePath: "/assets/xconecta-seed-logo.svg",
      ...
      endpoints: [
        {
          method: "GET",
          path: "/",
          purpose: "Entry page for the xconecta marketplace host reference.",
        },
        {
          method: "GET",
        ...
        {
          method: "GET",
          path: "/host/xconecta-marketplace-host.js",
          purpose: "Browser bootstrap for the marketplace host reference.",
        },
        {
          method: "GET",
          path: "/host/xconecta-single-xapp-host.js",
        ...
        {
          method: "GET",
          path: "/assets/xconecta-seed-logo.svg",
...
if (!TENANT_PAYMENT_RETURN_SECRET) {
  fastify.log.warn(
    "[xconecta] XCONECTA_TENANT_PAYMENT_RETURN_SECRET is not set. Payment evidence HMAC verification is disabled. Set this secret for production use.",
  );
}
...
try {
  ...
  fastify.log.info(
    ...
    "xconecta tenant backend running",
  );
} catch (err) {
